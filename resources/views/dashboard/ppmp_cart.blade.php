<x-dashboard-layout>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a class="submit-btn btn btn-link btn-sm float-end" href="{{ route('ppmp-activity-log.show', ['branch_id' => Auth::user()->branches_id]) }}"><em class="bi bi-clock-history"></em> Activity Logs</a>
            ...
            <tbody>
                ...
                @foreach ($cart_items as $item)
                    ...
                    <tr @if ($item->is_priority === 1) class="table-primary" @endif>
                        ...
                        <td>{{ $item->remarks }}</td>
                        <td>
                            <a href="{{ route('get-ppmp-record.show', ['ppmp_id' => $item->id]) }}" type="button" class="btn btn-primary btn-sm m-1"><em class="bi bi-pencil-fill"></em></a>
                            <button type="button" onclick="deleteFromCart({{$item->id}})" class="btn btn-danger btn-sm m-1"><em class="bi bi-trash-fill"></em></button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
