<x-dashboard-layout>
    <x-slot:title>
        Inventory Custodian Receipt - General Inventory
    </x-slot>

    @php
        $breadcrumb = [
            ['name' => '<em class="bi bi-house-fill"></em>', 'route' => 'dashboard.show'],
            ['name' => 'Inventory Custodian Receipt - General Inventory'],
        ]
    @endphp
    ...
    <form method="POST" action="{{ route('gi-ics.post') }}">
        <div class="row mb-4">
            @csrf
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover caption-top" id="gi-ics-tbl">
            <caption>Generated Reports for Inventory Custodian Receipt (ICS) - General Inventory</caption>
            <thead>
                <tr>
    ...
    @include('layout/datatable', ["tableId" => "gi-ics-tbl"])
    </x-slot>
</x-dashboard-layout>