                        ...
                        <td>
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>{{ $transfer->quantity }} {{ $transfer->item->bac_reso_item->quotation->pr_item->ppmp->item_detail->unit->uom }}</div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div>₱ {{ number_format($transfer->item->bac_reso_item->quotation->offered_unit_price * $transfer->quantity, 2) }}</div>
                                </div>
                            </div>
                        </td>
