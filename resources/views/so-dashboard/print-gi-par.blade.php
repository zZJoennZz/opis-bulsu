...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <title>
            {{ $content->end_user->first_name . ' ' . $content->end_user->middle_name . ' ' . $content->end_user->last_name }} as of {{ $snapShot->created_at }} Property Acknowledgement Receipt (General Inventory) |  OPIS - BulSU e-PROCUREMENT
        </title>
                ...
                <div class="row mb-4">
                    <div class="col-7 m-auto">
                        ...
                        <div class="text-center">
                            ...
                            <div class="fw-bold text-uppercase mt-5">Property Acknowledgement Receipt</div>
                        </div>
                    </div>
                </div>
