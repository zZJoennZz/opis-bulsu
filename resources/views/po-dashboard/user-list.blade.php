                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @else
                                <a class="btn btn-sm btn-success" @if($user->is_active!==1) style="opacity: 0.5;" @else href="{{ route('view-user.show', ['user_id' => $user->id]) }}" @endif><em class="bi bi-pencil-square"></em></a>
                            @endif
                        </td>
                        <td class="p-2">
