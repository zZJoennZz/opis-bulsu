            ...
            <div class="pt-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h1 class="h5 card-title"><span class="float-end small"># of records: <span class="badge text-bg-secondary">{{ count($item_details) }}</span></span></h1
                        <div class="mb-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn @if($item->is_approve === 0) btn-secondary @else btn-primary @endif" @if($item->is_delete===1) style="opacity: 0.5;" @else href="{{ route('view-item-detail.show', ['item_detail_id' => $item->id]) }}" @endif>@if($item->is_approve === 0) <em class="bi bi-eye"></em> @else <em class="bi bi-pencil-square"></em> @endif</a>
                                        </td>
                                        <td>
