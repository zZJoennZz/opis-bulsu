<x-dashboard-layout>
    ...
    <span class="float-end small"># of records: <span class="badge text-bg-secondary">{{ count($item_categories) }}</span></span>
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover" id="item-category-table">
